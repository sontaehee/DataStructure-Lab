...
public class StackLinkedListStringTest {
	final static private Logger LOG = LoggerFactory.getLogger(StackLinkedListStringTest.class);

	static StackLinkedList<String> stack;
	
	@BeforeAll
	static public void beforeAll() {
		LOG.info("Before All");
		stack = new StackLinkedList<String>(5);
	}
